...
abstract class ArtifactStore[DocumentAbstraction] extends Spi {

    /** Execution context for futures */
    protected[core] implicit val executionContext: ExecutionContext

    //implicit val logging: Logging
    override protected[core] def logging:Logging = super.logging

    //need an init function for anything unavailable from super.config or super.system (those can be set via lazy val)
